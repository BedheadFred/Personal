...
var allowNextPageTouchScroll = true;
    ...
    $.fn.pagepiling = function (custom) {
        ...
        */
        ...
        var scrollCounter = 0;
         ...
         //This function continually pushes the direction of scrolling to the scrolling function. It does it by detecting wheel delta.
         //The scrolling function itself will handle scrollings to oher sections.
        ...
        */
        ...
        function scrolling(type, scrollable){
            ...
            //set the function scrollSection according to the direction of scroll
            if (type == 'down') {
                check = 'bottom';
            ...
            if(scrollable.length > 0 ){
                ...
                if(isScrolled(check, scrollable)) {
                    ...
                    if (stopScroll == false && allowNextPageTouchScroll == true) {
                        scrollSection();
                    };
                } else{
                    return true;
        ...
        */
        function touchMoveHandler(event){
            ...
            $('.pp-section.active').on('touchstart', function() {
                //console.log("start");
                if (allowNextPageTouchScroll != false) {
                    setTimeout(function() {
                        allowNextPageTouchScroll = false;
                    }, 100);
                }
            });

            $('.pp-section.active').on('touchmove', function() {
                //console.log("moving");
                if (allowNextPageTouchScroll != false) {
                    setTimeout(function() {
                        allowNextPageTouchScroll = false;
            ...
            $('.pp-section.active').on('touchend', function() {
                //console.log("end");
                if (allowNextPageTouchScroll != true) {
                    setTimeout(function() {
                        allowNextPageTouchScroll = true;
                    }, 200);
                }
            });
            ...
            if ( !checkParentForNormalScrollElement(event.target) && isReallyTouch(e) ) {
                ...
                if (!isMoving()) {
                  ...
                  //$('body').append('<span style="position:fixed; top: 250px; left: 20px; z-index:88; font-size: 25px; color: #000;">touchEndY: ' + touchEndY  + '</div>');
                    ...
                    /*
                    //for slowing down touch next page scrolling on mobile
                    activeSection.on('touchmove', function() {
                        setTimeout(function() {
                            allowNextPageTouchScroll = false;
                        }, 100);
                    });
                    */
                    ...
                    /*
                    activeSection.on('touchend', function() {
                        allowNextPageTouchScroll = false;
